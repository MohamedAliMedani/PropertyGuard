    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl p-6 border border-border text-center">
          ...
          <p className="text-sm text-muted-foreground">{t('profile.customerSince')}</p>
          <button className="mt-4 px-4 py-2 border border-border rounded-lg hover:bg-muted transition-colors text-sm">
        ...
        <div className="md:col-span-2 bg-white rounded-xl p-6 border border-border">
          ...
          <div className="space-y-4">
            ...
            <button className="w-full px-6 py-2.5 bg-[#059669] text-white rounded-lg hover:bg-[#047857] transition-colors">
      ...
      <div className="bg-white rounded-xl p-6 border border-border">
        ...
        <div className="space-y-4 max-w-md">
          ...
          <button className="px-6 py-2.5 bg-[#1e3a8a] text-white rounded-lg hover:bg-[#1e40af] transition-colors">
